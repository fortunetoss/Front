...
export const updateAllState = (data: Partial<PocketState>) => {
    const { setTitle,  setAnswers, setContent, setCard, setDomain, setCorrectAnswer, setQuestionCustomId, setStep,} = usePocketStore.getState();
    ...
    if (data.questionCustomId) setQuestionCustomId(data.questionCustomId);
