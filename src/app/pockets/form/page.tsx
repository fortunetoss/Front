    ...
    const handleSubmit = async () => {
        ...
        try {
            ...
            if (isModified && questionCustomId) {
                await postEdit(title, answers, answers[selectedAnswer], null, domain, null);
                alert("복주머니가 수정되었습니다!");
            } else {
                await submitCustomQuestion(title, answers, answers[selectedAnswer], null, domain, null);
                ...
                <div className="flex justify-end mt-4">
                    <button
                        ...
                        className={`px-6 py-2 rounded text-xl transition ${
                            selectedAnswer !== null ? "text-blue hover:text-blue-700" : "text-black"
                        }`}
                    >
                        다음
                    </button>
